...
########################  letonn/LltHoN1 Userbot ~ By: zira (@S_1_02)  ########################
ZelzalTHS_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝐋𝐈𝐓𝐇𝐎𝐍 - اوامـر التحشيش](t.me/A1DIIU) 𓆪\n\n"
...
async def ahmed(ahmed): # Code Update by @S_1_02
    zira = ahmed.pattern_match.group(1)
    zilzal = await ahmed.get_reply_message()
    zel_zal = random.choice(kettuet)
    if not zilzal and not zira: # Code Update by @S_1_02
...
# Copyright (C) 2022 𝐋𝐈𝐓𝐇𝐎𝐍 . All Rights Reserved
