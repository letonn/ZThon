...
async def get_adzan(adzan):
    ...
    if zira == "صنعاء" or zira == "اليمن":
	    ...
	    zedthonresult = f"<b>🕋╎اوقـات الصـلاة بالتـوقيت المحلـي لعواصـم الـدول <b>\
		        ...
		        \n\nᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝐋𝐈𝐓𝐇𝐎𝐍╎ @A1DIIU\
	    "
	    await edit_or_reply(adzan, zedthonresult, "html")
    elif zira == "مصر" or zira == "القاهرة" or zira == "القاهره":
	    ...
	    "
	    await edit_or_reply(adzan, zedthonresult, "html")
    elif zira == "بغداد" or zira == "العراق":
	    ...
	    "
	    await edit_or_reply(adzan, zedthonresult, "html")
    elif zira == "مسقط" or zira == "سلطنه عمان":
	    ...
	    "
	    await edit_or_reply(adzan, zedthonresult, "html")
    elif zira == "مكه" or zira == "السعوديه":
	    ...
	    "
	    await edit_or_reply(adzan, zedthonresult, "html")
    elif zira == "الرباط" or zira == "المغرب":
	    ...
	    "
	    await edit_or_reply(adzan, zedthonresult, "html")
    elif zira == "الخرطوم" or zira == "السودان":
	    ...
	    "
	    await edit_or_reply(adzan, zedthonresult, "html")
    elif zira == "بنغازي" or zira == "ليبيا":
	    ...
	    "
	    await edit_or_reply(adzan, zedthonresult, "html")
    elif zira == "ازمير" or zira == "اسطنبول" or zira == "انقره" or zira == "تركيا":
