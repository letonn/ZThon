...
# Copyright (C) 2023 T.me/A1DIIU . All Rights Reserved
...
################# Dev ZilZal #################
    ZThon = f'<a href="T.me/A1DIIU">ᯓ 𝐋𝐈𝐓𝐇𝐎𝐍 𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺 𝗗𝗮𝘁𝗮 📟</a>'
    ZThon += f"\n<b>⋆─┄─┄─┄─┄─┄─┄─⋆</b>\n\n"
    ...
    ZThon += f"<b>- الإنشـاء   ⤎</b>  {zzzsinc}  🗓" #Code by T.me/zzzzl1l
    return ZThon
...
async def fetch_info(replied_user, event):
    ...
    if zilzal == True or user_id in zelzal: #Code by T.me/zzzzl1l
        ...
        zpre = "𝕍𝕀ℝ𝕋𝕌𝔸𝕃 ✨"
    if user_id in Zed_Vip: #Code by T.me/zzzzl1l
        zvip = "𝕍𝕀ℙ 💎"
    else:
        zvip = "ℕ𝕆ℕ𝔼"
...
################# Dev ZilZal #################
    if user_id in zelzal: #Code by T.me/zzzzl1l
        ...
        rotbat = "العضـو 𓅫"
################# Dev ZilZal #################
    ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت ليثون"  #Code by T.me/zzzzl1l
    ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦ " #Code by T.me/zzzzl1l
    ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─┄─ 𝐋𝐈𝐓𝐇𝐎𝐍 ─┄─┄─┄─⋆" #Code by T.me/zzzzl1l
...
async def zelzalll(event): #Write Code By Zelzal T.me/zzzzl1l
