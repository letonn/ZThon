...
Copyright (C) 2023 𝐋𝐈𝐓𝐇𝐎𝐍 . All Rights Reserved
Credit: https://github.com/letonn/LltHoN1
Devloper: https://t.me/S_1_02 - 𝐋𝐄𝐀𝐃𝐄𝐑 𝐒𝐀𝐃𝐃𝐀𝐌 𝐇𝐔𝐒𝐒𝐄𝐈𝐍"""
"""import json
import math
import asyncio
import os
...
async def inline_handler(event):
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:  # Code by T.me/S_1_02
        ...
        malathid = user_id
    if query_user_id == Config.OWNER_ID or query_user_id == user_id or query_user_id == int(user_id) or query_user_id in Config.SUDO_USERS:  # Code by T.me/S_1_02
