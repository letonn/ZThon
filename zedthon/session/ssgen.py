...
def telethon_session():
    ...
    # logging in
    try:
        with TelegramClient(StringSession(), API_ID, API_HASH) as LITHON:
            print("Generating a string session for •LITHON•")
            try:
                LITHON.send_message(
                    "me",
...
def pyro_session():
    ...
    with Client(
        name="LITHON", api_id=API_ID, api_hash=API_HASH, in_memory=True
    ) as pyro:
