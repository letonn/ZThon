...
async def mybot(): #Code by T.me/zzzzl1l
    if gvarstatus("z_assistant"):
        ...
        try:
            ...
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", "ll0llld")
    ...
    try:
        if BOTLOG:
            ...
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                ...
                buttons=[[Button.url("𝕃𝕃𝕋ℍ𝕆ℕ 🎡 𝕌𝕤𝕖𝕣𝕓𝕠𝕥", "https://t.me/ll0llld")],[Button.url("الشروحات ²", "https://t.me/A1DIIU"), Button.url("الشروحات ¹", "https://t.me/L_Q7I")],[Button.url("حلـول الأخطـاء", "https://t.me/cecrr")],[Button.url("التحـديثـات", "https://t.me/SUPERXFAST")],[Button.url("مطـور السـورس", "https://t.me/H_8_o")]]
            )
    except Exception as e:
        LOGS.error(e)
        return None
    ...
    if BOTLOG:
        ...
        try:
            ...
            _, groupid = await create_supergroup(
                "مجمـوعـة السجـل ليثــون", zedub, Config.TG_BOT_USERNAME, descript, photozed
            )
            ...
            if "can't create channels or chat" in str(e):
                ...
                print("- قم بالذهاب الى طريقة الحل عبر الرابط (https://t.me/ll0llld/22)")
