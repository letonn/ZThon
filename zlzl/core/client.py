...
ZDEV = (7004732448, 7004732448, 7227372419, 7062976039, 6094238403, 6094238403, 7004732448)
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\n--------بـدء تتبـع سجـل ليثــون 𝕃𝕃𝕋ℍ𝕆ℕ--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع ليثــون 𝕃𝕃𝕋ℍ𝕆ℕ--------"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار زدثـــون 𝕃𝕃𝕋ℍ𝕆ℕ ✘**\n\n "
                        link = "[𝐋𝐄𝐀𝐃𝐄𝐑 𝐒𝐀𝐃𝐃𝐀𝐌 𝐇𝐔𝐒𝐒𝐄𝐈𝐍](https://t.me/H_8_o)"
