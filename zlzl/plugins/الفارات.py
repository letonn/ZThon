...
ZelzalVP_cmd = (
    "𓆩 𝕃𝕃𝕋ℍ𝕆ℕ 𝕍𝕒𝕣𝕤 **🝢 اوامـر الفـارات** 𓆪\n"
    "**⋆┄─┄─┄─┄─┄─┄─┄─┄⋆**\n"
    ...
    "⪼ قنـاة كلايـش حمايـة الخـاص @ll0llld\n\n"
    ...
    "\n𓆩 [𝕃𝕃𝕋ℍ𝕆ℕ 𝕍𝕒𝕣𝕤 - قنـاة الفـارات](t.me/ll0llld) 𓆪"
)


ZelzalTZ_cmd = (
    "𓆩 𝕃𝕃𝕋ℍ𝕆ℕ 𝕋𝕚𝕞𝕖 **🝢 المنطقة الزمنية** 𓆪\n"
    "**⋆┄─┄─┄─┄─┄─┄─┄─┄⋆**\n"
