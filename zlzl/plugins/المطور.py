...
ZelzalDV_cmd = (
    "[ᯓ 𝕊𝕠𝕦𝕣𝕔𝕖 𝕃𝕃𝕋ℍ𝕆ℕ - اوامــر المطـور المســاعد](t.me/ll0llld) .\n\n"
    ...
    "\n𓆩 [𝕃𝕃𝕋ℍ𝕆ℕ 𝕌𝕤𝕖𝕣𝕓𝕠𝕥](t.me/ll0llld) 𓆪"
)
...
async def _(event):
    ...
    result = "**•❐• قائمــة مـطـورين البــوت الخـاص بـك مـن 𝕃𝕃𝕋ℍ𝕆ℕ :**\n\n"
...
async def _(event):  # sourcery no-metrics
    ...
    output = (
        result + "**⎉╎يتم الان اعـادة تشغيـل بـوت ليثــون انتظـر 2-1 دقيقـه ▬▭ ...**\n"
    )
    if errors != "":
        output += "\n**- خطــأ :**\n" + errors
